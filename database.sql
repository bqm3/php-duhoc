...
INSERT INTO `categories` VALUES (3,'Du học','du-hoc',0,0,'2026-01-07 07:40:15'),(4,'Học bổng','hoc-bong',0,0,'2026-01-07 07:40:42'),(6,'Tin tức','tin-tuc',0,0,'2026-01-07 07:41:02'),(7,'Chi phí','chi-phi',0,0,'2026-01-08 10:38:12'),(8,'Visa','visa',0,0,'2026-01-08 10:38:31'),(9,'Ngoại ngữ','ngoai-ngu',0,0,'2026-01-08 10:39:16'),(10,'Bảo hiểm và phúc lợi','bao-hiem-va-phuc-loi',0,0,'2026-01-08 10:40:20'),(11,'Ngành học nổi tiếng','nganh-hoc-noi-tieng',0,0,'2026-01-08 10:40:33'),(12,'Dịch vụ','dich-vu',0,0,'2026-01-08 10:44:01'),(13,'Tổng quan','tong-quan',0,0,'2026-01-29 09:16:48');
...
CREATE TABLE `files` (
  ...
  `url_file` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('image','file') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'file',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_files_category` (`category_id`),
  KEY `idx_files_country` (`country_id`),
  KEY `idx_files_user` (`user_id`),
  KEY `idx_files_type` (`type`),
  CONSTRAINT `fk_files_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_files_country` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO `files` VALUES (1,10,6,2,'bảo hiểm và phúc lợi anh','/assets/uploads/lib_1768961038_93b9d7d8.pdf','file','2026-01-21 09:03:58',NULL),(2,10,12,2,'bảo hiểm và phúc lợi canada','/assets/uploads/files/lib_1768961273_481cdfe3.pdf','file','2026-01-21 09:06:06','2026-01-21 09:07:53');
...
-- Dump completed on 2026-01-29 16:27:12
