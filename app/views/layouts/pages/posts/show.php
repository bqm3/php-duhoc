        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent p-0">
                        ...
                        <li class="breadcrumb-item"><a
                                href="#"><?= htmlspecialchars($post['category_name'] ?? 'Tin tức') ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?= htmlspecialchars($post['title']) ?>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="d-flex align-items-center text-muted mb-4">
                    <small class="mr-3"><i class="fa fa-user mr-1"></i>
                        <?= htmlspecialchars($post['creator_name'] ?? 'Admin') ?></small>
                    <small class="mr-3"><i class="fa fa-calendar mr-1"></i>
