                    ...
                    <div class="card border-0 shadow-sm p-4 sticky-top" style="top: 100px; z-index: 10;">
                        ...
                        <div class="news-sidebar-list">
                            <?php foreach ($sidebarPosts as $sp): ?>
                                <div class="news-sidebar-item mb-3 pb-3 border-bottom">
                                    <a href="<?= $base . '/' . $sp['slug'] ?>" class="text-decoration-none d-flex gap-3">
                                        <div class="flex-shrink-0">
                                            <img src="<?= $base . ($sp['featured_image'] ?: '/assets/images/no-image.jpg') ?>"
                                                alt="<?= htmlspecialchars($sp['title']) ?>"
                                                style="width: 70px; height: 70px; object-fit: cover; border-radius: 8px;">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 style="font-size: 0.9rem; font-weight: 600; line-height: 1.4;"
                                                class="text-dark mb-1">
                                                <?= htmlspecialchars($sp['title']) ?>
                                            </h6>
                                            <small class="text-muted">
                                                <?= date('d/m/Y', strtotime($sp['created_at'])) ?>
                                            </small>
                                        </div>
                                    </a>
                                </div>
