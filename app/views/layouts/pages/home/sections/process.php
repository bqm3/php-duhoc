...
<section class="vnpc-process" style="background-image: url('<?= $base ?>/assets/img/client/img_home18.png');">
  <div class="vnpc-process-overlay"></div>

  <div class="process-container">
    <!-- Decoration top right -->
    <img src="<?= $base ?>/assets/img/client/img_home12.png" class="p-deco-1" alt="">
    <img src="<?= $base ?>/assets/svgs/clients/ic_home8.svg" class="p-deco-2" alt="">

    <!-- Title group -->
    <div class="p-h-sub">hành<br>trình</div>
    <div class="p-num-big">6</div>
    <div class="p-h-main">Bước<br>du học cùng tôi</div>
    <img src="<?= $base ?>/assets/img/client/img_home16.png" class="p-h-img" alt="">

    <!-- Timeline Graphics -->
    <img src="<?= $base ?>/assets/svgs/clients/ic_location_2.svg" class="loc-ico" alt="">
    <img src="<?= $base ?>/assets/svgs/clients/ic_home9.svg" class="tar-ico" alt="">

    <!-- Main connecting line -->
    <svg class="timeline-svg" viewBox="0 0 1229 6" fill="none">
    ...
    $steps = [
      ...
      ['id' => '06', 'left' => 'calc(50% + 446px)', 'dot' => 'calc(50% + 542px)', 'title' => 'Hỗ trợ<br>quá trình học', 'desc' => 'Điền thông tin cá nhân, tài chính, nguyện vọng và khả năng ngoại ngữ.'],
    ];

    foreach ($steps as $s): ?>
      <!-- Dotted vertical line -->
      <svg class="dotted-svg" style="left: <?= $s['dot'] ?>;" viewBox="0 0 2 65">
          <line x1="1" y1="0" x2="1" y2="65" stroke="#2FC7A1" stroke-width="2" stroke-dasharray="4 4" />
      </svg>

      <div class="vnpc-step-item" style="left: <?= $s['left'] ?>;">
          <div class="step-ring-bg"></div>
          <div class="step-card">
              <div class="step-card-h"><?= $s['title'] ?></div>
              <div class="step-card-p"><?= htmlspecialchars($s['desc']) ?></div>
          </div>
          <div class="step-ring-white"></div>
          <div class="step-ring-inner"><?= $s['id'] ?></div>
      </div>
    <?php endforeach; ?>

    <!-- Bottom/Side decoration images -->
    <img src="<?= $base ?>/assets/img/client/img_home17.png" class="p-img-1" alt="">
    <img src="<?= $base ?>/assets/img/client/img_home19.png" class="p-img-2" alt="">
  </div>
</section>