    ...
    <div class="row g-4 mb-5">
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <div class="d-flex align-items-center gap-2 mb-3">
          <img src="<?= $base ?>/assets/svgs/clients/ic_phone_white.svg" width="20" height="20" alt="Điện thoại"
            onerror="this.style.display='none'" loading="lazy" decoding="async">
          <span>
            <a class="text-white text-decoration-none"
              href="tel:<?= $phones[0] ?>"><?= htmlspecialchars(substr($phoneText, 0, 12)) ?></a>
            <span style="opacity:.7;"> | </span>
            <a class="text-white text-decoration-none"
              href="tel:<?= $phones[1] ?>"><?= htmlspecialchars(substr($phoneText, 15)) ?></a>
          </span>
        </div>
        ...
        <address class="mb-3" style="font-style: normal;">
          ...
          <div class="d-flex gap-2">
            <img src="<?= $base ?>/assets/svgs/clients/ic_location_white.svg" width="16" height="20" alt="Địa chỉ"
              onerror="this.style.display='none'" loading="lazy" decoding="async">
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <div class="mb-4" style="border-radius: 8px; overflow: hidden; height: 150px;">
          <iframe title="Bản đồ văn phòng VNPC"
