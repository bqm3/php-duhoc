...
<section class="vnpc-newsletter" style="position: relative; z-index: 10; margin-bottom: -100px; padding: 0 20px;">
  <div class="container-xxl">    <div class="newsletter-section" style="position: relative; z-index: 10; width: 100%; display: flex; justify-content: center; margin-bottom: -100px; padding: 0 20px;">
...
<!-- Footer -->
<footer class="vnpc-footer" style="width: 100%; background: #0C4073; color: white; padding-top: 140px; padding-bottom: 40px;">
    ...
    <div class="row g-4 mb-5">
      ...
      <div class="col-lg-4 col-md-6">
        ...
        <div class="d-flex align-items-center gap-2 mb-3">
          <img src="<?= $base ?>/assets/svgs/clients/ic_phone_white.svg" 
        ...
        <div class="mb-3">
          ...
          <div class="d-flex gap-2">
            <img src="<?= $base ?>/assets/svgs/clients/ic_location_white.svg" 
                 width="16" height="20" alt="" 
                 onerror="this.style.display='none'">
