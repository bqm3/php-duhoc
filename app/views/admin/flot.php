...
<?php include 'sidebar.php'; ?>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                <h5 class="mb-0" ><strong>Flot Chart</strong></h5>
                <span class="text-secondary">Charts <i class="fa fa-angle-right"></i> Flot js</span>
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div id="barChartFlot"  style="width: 100%; height:350px"></div>
                        </div>
                        <!--/Bar Chart-->
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div id="pieChartFlot" style="width: 100%; height:350px"></div>
                        </div>
                        <!--/Doughnut Chart-->
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div id="stackedBarChartFlot"  style="width: 100%; height:350px"></div>
                        </div>
                        <!--/Stacked Bar Chart-->
                    ...
                    <div class="col-sm-6">
                        <!--Doughnut Chart-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            <h6 class="mb-2">Area chart</h6>
                            
                            <div id="areaChartFlot" style="width: 100%; height:350px"></div>
                        </div>
                        <!--/Doughnut Chart-->
                    </div>
                </div>
