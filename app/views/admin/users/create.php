...
<div class="container-fluid">
    ...
    <div class="row main-content">
        ...
        <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
            <div class="mb-3">
                <h5 class="mb-0"><strong>Thêm người dùng mới</strong></h5>
                <span class="text-secondary">Dashboard <i class="fa fa-angle-right"></i> Users <i class="fa fa-angle-right"></i> Create</span>
            </div>
