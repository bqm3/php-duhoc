                        ...
                        <div class="mt-1 mb-3 p-4 button-container bg-white border shadow-sm">
                            <form method="POST" action="<?= $base ?>/admin/schools" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tuition_fee" placeholder="Ví dụ: 10.000 - 15.000 USD/năm">
                                </div>
            ...
            function uploadImage(file) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.url) {
                            $('#summernote').summernote('insertImage', "<?= $base ?>" + response.url, function($image) {
                                $image.css('width', '100%');
                            });
                        } else {
