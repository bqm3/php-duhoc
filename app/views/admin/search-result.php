...
<?php include 'sidebar.php'; ?>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                <h5 class="mb-0" ><strong>Search</strong></h5>
                <span class="text-secondary">Pages <i class="fa fa-angle-right"></i> Search result</span>
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm lh-sm">
                            <form action="" class="mb-4">
                                <div class="input-group mt-2">
                                    <input type="text" class="form-control shadow-sm" placeholder="Search keywords" aria-label="Search keywords" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-theme" type="button" id="button-addon2">Search</button>
                                    </div>
                                </div>
                            </form>

                            <h5 class="search-header mb-0">Search Results for "Elementjs"</h5>
                            <small class="text-muted search-slug">About 10,100 results (0.41 seconds)</small>

                            <div class="search-single mb-3 p-3">
                                <h5 class="text-dark">Elementjs</h5>
                                <a href="#" class="">https://www.google.com/elementjs</a>
                                <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            </div>

                            <div class="dropdown-divider"></div>

                            <div class="search-single mt-3 mb-3 p-3">
                                <h5 class="text-dark">Elementjs</h5>
                                <a href="#" class="">https://www.google.com/elementjs</a>
                                <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            </div>
