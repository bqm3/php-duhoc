        ...
        <div class="row main-content">
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= $base ?>/admin/countries/create" class="btn btn-primary"><i class="fa fa-plus"></i> Thêm mới</a>
                </div>
                    ...
                    <div class="col-sm-12">
                        <form method="GET" action="" class="mb-3">
                            <div class="input-group" style="max-width: 400px;">
                                <input type="text" name="keyword" class="form-control" placeholder="Tìm kiếm tên, mã..." value="<?= htmlspecialchars($keyword ?? '') ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($item['flag_url']): ?>
                                                        <img src="<?= $base . $item['flag_url'] ?>" style="height: 30px; border: 1px solid #ddd;">
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="<?= $base ?>/admin/countries/<?= $item['id'] ?>/edit" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
