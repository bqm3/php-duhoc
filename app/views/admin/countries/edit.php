                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        <div class="mt-1 mb-3 p-4 button-container bg-white border shadow-sm">
                            <form method="POST" action="<?= $base ?>/admin/countries/<?= $country['id'] ?>/update"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug"
                                        value="<?= htmlspecialchars($country['slug']) ?>" readonly>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if ($country['flag_url']): ?>
                                                <div class="mb-2"><img src="<?= $base . $country['flag_url'] ?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php if ($country['image_url']): ?>
                                                <div class="mb-2"><img src="<?= $base . $country['image_url'] ?>"
                                ...
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input" id="is_popular" name="is_popular"
                                        value="1" <?= $country['is_popular'] ? 'checked' : '' ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="summernote"
                                        class="form-control"><?= htmlspecialchars($country['description']) ?></textarea>
                                </div>
