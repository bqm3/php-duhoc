...
<html lang="en">
  <head>
    ...
    <!--JsGrid CSS-->
    <link rel="stylesheet" href="/php-duhoc/public/assets/css/jsgrid.min.css">
    <link rel="stylesheet" href="/php-duhoc/public/assets/css/jsgrid-theme.min.css">
...
<?php include 'sidebar.php'; ?>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        ...
                        <!--JsGrid Sorting-->
                        <div class="mt-1 mb-4 p-3 button-container bg-white border shadow-sm">
                            <h6 class="mb-2">Sorting</h6>
                            
                            <div class="sort-panel row mb-2">
                                <div class="col-sm-4 pr-1">
                                    <select id="sortingField" class="custom-select">
                                        <option>Name</option>
                                        <option>Age</option>
                                ...
                                <div class="col-sm-">
                                    <button type="button" class="btn btn-theme btn-round" id="sort">Sort rows</button>
                                </div>
                            </div>
                            <div id="jsGrid2"></div>
                        </div>
    ...
    <!--Bootstrap Calendar-->
    <!--JsGrid table-->
    <script src="/php-duhoc/public/assets/js/jsgrid.min.js"></script>
    <script src="/php-duhoc/public/assets/js/jsgrid-demo.js"></script>
