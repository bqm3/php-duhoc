...
<?php include 'sidebar.php'; ?>
            ...
            <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                <h5 class="mb-0" ><strong>Chartist Charts</strong></h5>
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div class="ct-chart" id="lineChartChartist"  style="height: 300px;"></div>
                        </div>
                        <!--/Line Chart-->
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container  bg-white shadow-sm border">
                            ...
                            <div class="ct-chart" id="areaChartChartist"  style="height: 300px;"></div>
                        </div>
                        <!--/Area Table-->
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        <!--Bar Chart-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            <h6 class="mb-2">Overlapping Bar chart</h6>
                            
                            <div class="ct-chart" id="overlapBarchartChartist"  style="height: 300px;"></div>
                        </div>
                        <!--/Bar Chart-->
                    ...
                    <div class="col-sm-6">
                        <!--Stacked bar Chart-->
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            <h6 class="mb-2">Stacked bar chart</h6>
                            
                            <div id="stackedBarchartChartist" style="height: 300px;"></div>
                        </div>
                        <!--/Stacked bar Chart-->
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div class="ct-chart" id="pieChartChartist"  style="height: 300px;"></div>
                        </div>
                        <!--/Pie Chart-->
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div class="ct-chart" id="donutChartChartist" style="height: 300px;"></div>
                        </div>
                        <!--/Doughnut Chart-->
                    </div>
                </div>
