...
class EventController
{
    public function index()
    {
        ...
        // 1. Get Category ID for "su-kien"
        $stmt = $pdo->prepare("SELECT id, name FROM categories WHERE slug = 'su-kien' AND is_delete = 0 LIMIT 1");
        $stmt->execute();
    ...
    ");
        ...
        view('main', 'layouts/pages/sukien/index', [
            'title' => $category['name'],
