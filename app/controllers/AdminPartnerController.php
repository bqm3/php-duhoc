...
class AdminPartnerController
{
    ...
    private static function saveUploadedImage($file, $prefix)
    {
        ...
        $uploadDir = rtrim($_SERVER['DOCUMENT_ROOT'], '/') . '/assets/uploads/partners';
        ...
        if (!move_uploaded_file($file['tmp_name'], $dest)) {
            throw new Exception("Upload failed (move_uploaded_file). Kiểm tra quyền ghi folder assets/uploads/partners.");
        }
